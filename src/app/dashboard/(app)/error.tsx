...
export default function DashboardError({
  ...
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center gap-[1rem] text-center">
      <p className="text-h3 text-ink">Something went wrong.</p>
      <p className="text-body max-w-[24rem] text-muted">
      ...
      <button
        type="button"
        onClick={reset}
        className="text-body rounded-[0.4rem] bg-ink px-[1.25rem] py-[0.625rem] font-medium text-white"
      >
        Try Again
      </button>
    </div>
